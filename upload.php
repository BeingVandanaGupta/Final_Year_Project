    ...
    <nav class="navbar navbar-expand beta-menu navbar-dropdown align-items-center navbar-fixed-top navbar-toggleable-sm">
        ...
        <div class="menu-logo">
            <div class="navbar-brand">
                <span class="navbar-logo">
                    <a href="index.html">
                         <img src="assets/images/logo-1.png" alt="Mobirise" title="" style="height: 4.8rem;">
                    </a>
                </span>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav nav-dropdown nav-right" data-app-modern-menu="true"><li class="nav-item">
                    <a class="nav-link link text-white display-4" href="notes.html"><span class="mbri-edit mbr-iconfont mbr-iconfont-btn"></span>
                        Notes
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link link text-white display-4" href="papers.html"><span class="mbri-file mbr-iconfont mbr-iconfont-btn"></span>
                        Papers
                    </a>
                </li></ul>
...
<section class="header3 cid-rUT4tYLnG0 mbr-fullscreen mbr-parallax-background" id="header3-4">
